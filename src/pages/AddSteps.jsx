        ...
        <div className="container">
          <div className="add-cont">
            ...
            {step === 1 ? (
              ...
              <UnitBasics formData={formData} setFormData={setFormData} />
            ) : step === 5 ? (
              <HouseFeatures formData={formData} setFormData={setFormData} />
            ) : step === 6 ? (
              <UnitImages formData={formData} setFormData={setFormData} />
            ) : step === 7 ? (
              <PublishDetails formData={formData} setFormData={setFormData} />
            ) : step === 8 ? (
              <FinalDetails formData={formData} setFormData={setFormData} />
            ) : null}
