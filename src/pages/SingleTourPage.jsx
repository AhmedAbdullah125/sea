...
const logo = <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" clipRule="evenodd" d="M27.8827 31.7796C24.0548 33.4989 19.5041 31.9041 17.7186 28.2174C15.9331 24.5315 17.5894 20.1492 21.418 18.4307C25.2459 16.7114 40.9994 17.7645 40.9994 17.7645C40.9994 17.7645 31.7105 30.0611 27.8827 31.7804V31.7796Z" fill="url(#paint0_linear_324_3821)" />
  <path fill-rule="evenodd" clipRule="evenodd" d="M30.1177 26.2208C33.9456 24.5015 38.4963 26.0963 40.2817 29.783C42.0672 33.4688 40.411 37.8512 36.5823 39.5697C32.7544 41.2889 17.001 40.2358 17.001 40.2358C17.001 40.2358 26.2898 27.9392 30.1177 26.22V26.2208Z" fill="url(#paint1_linear_324_3821)" />
  <defs>
...
const advantages = [
  {
    icon: <svg width="64" height="59" viewBox="0 0 64 59" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M27.1985 29.4999C34.5622 29.4999 40.5318 23.5304 40.5318 16.1666C40.5318 8.8028 34.5622 2.83325 27.1985 2.83325C19.8348 2.83325 13.8652 8.8028 13.8652 16.1666C13.8652 23.5304 19.8348 29.4999 27.1985 29.4999Z" stroke="#091B3C" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M2.66699 56.1667C4.18801 50.9219 7.32819 46.2923 11.6387 42.9397C15.9492 39.5872 21.2093 37.6832 26.667 37.5C37.6537 37.5 47.0137 45.26 50.667 56.1667" stroke="#091B3C" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M47.5216 9.34009C49.5528 10.3815 51.1965 12.0471 52.2109 14.0921C53.2253 16.137 53.557 18.4533 53.157 20.7008C52.757 22.9482 51.6466 25.0079 49.989 26.5775C48.3317 28.1469 46.2141 29.1431 43.9482 29.4199" stroke="#091B3C" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M46.1875 36.3535C49.7448 37.2599 53.0078 39.0687 55.6611 41.6055C58.3147 44.1421 60.2686 47.3204 61.3342 50.8332" stroke="#091B3C" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>,
    title: "04 أشخــــاص",
  },
  {
