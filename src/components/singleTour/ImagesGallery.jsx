    ...
    <>
      ...
      {images?.length > 0 ?
        <div className='grid grid-cols-12 gap-2'>
          ...
          {/* Thumbnails */}
          <div className={`${images?.length == 1 ? 'hidden' : ' xl:col-span-6'} h-[450px] max-xl:hidden  grid grid-cols-12 gap-2`}>
            {images.slice(1, 5).map((img, index) => (
              <div
                key={index}
