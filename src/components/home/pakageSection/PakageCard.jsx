    ...
    <Card className="shadow-none border-none col-span-12 md:col-span-6 xl:col-span-3 space-y-6">
      ...
      <CardFooter className="p-0">
        <div className="flex items-center justify-between gap-2 w-full">
          <button className="h-12 flex-grow  rounded-full   bg-main-purple text-white border-2 border-main-purple hover:bg-white hover:text-main-purple text-xs font-semibold ">إحجـــز رحلتك الان</button>
          <button className="group size-12 bg-main-purple border-2 border-main-purple hover:bg-white rounded-full flex items-center justify-center">
            <svg
