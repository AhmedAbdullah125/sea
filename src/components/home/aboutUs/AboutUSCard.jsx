  ...
  return (
    <Card className="shadow-none border-none bg-white py-12 px-5 rounded-[6rem] col-span-12 md:col-span-6 space-y-7">
      <CardHeader className="p-0">
        <img src="/aboutUs/about-icon.svg" alt="icon" loading="lazy" width={60} height={60} />
      </CardHeader>
      ...
      <CardFooter className="p-0">
        <p className="text-sm xl:text-basetext-main-navy line-clamp-3 leading-loose">{feature?.content}</p>
      </CardFooter>
    </Card>
  )
}
