...
const datePickers = [
  {
    ...
    icon: (
      < svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" >
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.5 9C1.5 8.37075 1.5 7.81148 1.50968 7.3125H16.4903C16.5 7.81148 16.5 8.37075 16.5 9V10.5C16.5 13.3284 16.5 14.7427 15.6213 15.6213C14.7427 16.5 13.3284 16.5 10.5 16.5H7.5C4.67157 16.5 3.25736 16.5 2.37868 15.6213C1.5 14.7427 1.5 13.3284 1.5 10.5V9ZM12.75 10.5C13.1642 10.5 13.5 10.1642 13.5 9.75C13.5 9.33577 13.1642 9 12.75 9C12.3358 9 12 9.33577 12 9.75C12 10.1642 12.3358 10.5 12.75 10.5ZM12.75 13.5C13.1642 13.5 13.5 13.1642 13.5 12.75C13.5 12.3358 13.1642 12 12.75 12C12.3358 12 12 12.3358 12 12.75C12 13.1642 12.3358 13.5 12.75 13.5ZM9.75 9.75C9.75 10.1642 9.41423 10.5 9 10.5C8.58578 10.5 8.25 10.1642 8.25 9.75C8.25 9.33577 8.58578 9 9 9C9.41423 9 9.75 9.33577 9.75 9.75ZM9.75 12.75C9.75 13.1642 9.41423 13.5 9 13.5C8.58578 13.5 8.25 13.1642 8.25 12.75C8.25 12.3358 8.58578 12 9 12C9.41423 12 9.75 12.3358 9.75 12.75ZM5.25 10.5C5.66421 10.5 6 10.1642 6 9.75C6 9.33577 5.66421 9 5.25 9C4.83579 9 4.5 9.33577 4.5 9.75C4.5 10.1642 4.83579 10.5 5.25 10.5ZM5.25 13.5C5.66421 13.5 6 13.1642 6 12.75C6 12.3358 5.66421 12 5.25 12C4.83579 12 4.5 12.3358 4.5 12.75C4.5 13.1642 4.83579 13.5 5.25 13.5Z" fill="#A71755" />
      </ svg>
    ),
  },
]
...
const TransportForm = () => {
  ...
  return (
    <Form {...form}>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-10 gap-x- xl:gap-y-6 gap-y-4">
        <div className="col-span-10 xl:mt-6 mt-4 flex items-center justify-between max-md:flex-col max-md:gap-y-4">
          ...
          <CustomCheckBox
            ...
            name="items"
            items={[
              { id: "dashboard", label: "نقل من و الى المطار" },
              { id: "settings", label: "جولات خـــاصة" }
            ]}
            
          />
        </div>
        {filterSelectFields.map((fieldProps, index) => (
          <CustomFilterSelect key={index} {...fieldProps} form={form} colSpan="xl:col-span-2 md:col-span-5 col-span-10" />
        ))}
        ...
        {datePickers.map((item) => (
          <CustomDatePicker
            ...
            label={item.label}
            form={form}
            colSpan="xl:col-span-2 md:col-span-5 col-span-10"
        ...
        <Button type="submit" className=" col-span-10 bg-main-purple w-fit m-auto text-white border-2 border-main-purple hover:bg-white hover:text-main-purple rounded-full flex items-center gap-14">بحـــــث
