...
const NewsletterCard = () => {
  return (
    <div className='space-y-4 h-[220px] bg-indigo-300 rounded-[65px] p-10 flex  flex-col justify-between'>
      <Dialog >
        ...
        <DialogContent className="xl:min-w-[50%] min-w-[90%] bg-white rounded-[40px] xl:px-8">
          <DialogHeader>
            <DialogDescription className="flex items-center justify-between">
              ...
              <Link  to={"#"} className=" h-12 px-8   bg-main-purple  text-xs font-bold  text-white hover:bg-main-blue hover:text-white transation-all duration-300  flex items-center justify-center gap-2 rounded-full ">
                تـــابعنا الان
