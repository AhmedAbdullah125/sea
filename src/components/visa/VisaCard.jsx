      ...
      <CardHeader className="p-0 " >
        <div className="p-0  flex items-center justify-between">
          ...
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" >
            <path d="M35.625 9.6001V16.6808" stroke="#130F26" strokeWidth="4" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M35.625 46.7837V52.7042" stroke="#130F26" strokeWidth="4" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M35.625 38.7839V24.6809" stroke="#130F26" strokeWidth="4" stroke-linecap="round" stroke-linejoin="round" />
